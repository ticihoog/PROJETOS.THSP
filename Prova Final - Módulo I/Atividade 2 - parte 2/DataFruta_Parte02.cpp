...
public:
    ...
    virtual void mostraPrimeirosNElementos(int N) = 0;
};
...
public:
    ...
    void listarEmOrdem() {
        if (!lista.empty()) {
            sort(lista.begin(), lista.end());
            cout << "Listando nomes em ordem:" << endl;
    ...
    void mostraPrimeirosNElementos(int N) {
        cout << "Primeiros " << N << " nomes: " << endl;
...
public:
    ...
    void listarEmOrdem() {
        if (!lista.empty()) {
            ...
            cout << "Listando datas em ordem:" << endl;
...
public:
    ...
    void mostraPrimeirosNElementos(int N) {
        cout << "Primeiros " << N << " salários: " << endl;
        for (int i = 0; i < min(N, static_cast<int>(lista.size())); i++) {
            cout << lista[i] << endl;
        }
    }
...
public:
    ...
    void listarEmOrdem() {
        if (!lista.empty()) {
            sort(lista.begin(), lista.end());
            cout << "Listando idades em ordem:" << endl;
            for (int idade : lista) {
                cout << idade << endl;
            }
        }
...
int main() {
    ...
    int N;
    cout << "Digite o número de elementos a serem listados: ";
    cin >> N;
